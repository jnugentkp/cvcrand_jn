...
In the design of CRTs with two arms, users can use the `cvrall()` function to perform covariate-constrained randomization. And for the analysis part, user would use the `cptest()` function for clustered permutation test. 
