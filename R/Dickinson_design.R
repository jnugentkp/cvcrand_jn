...
#' @description
#'   Two approaches (interventions) were compared for increasing the "up-to-date" immunization rate
...
#'   \item{africanamerican}{percentage of population that is African American}
